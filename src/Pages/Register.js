            ...
            <div id="register-comp" className="h-auto w-3/4 flex md:mt-2 justify-center m-auto p-4 md:border-black sm:border-none bg-[rgba(36, 37, 42,1)] ">
                <form id="registerForm" className="sm:p-24 md:px-24 md:py-12 sm:w-full md:w-1/2 md:border-2 flex flex-col bg-[#24252A] rounded-xl">
                    ...
                    <div className="text-center mt-12 mb-6">
                        <p className="text-[#e5f0f1]">Already a user ? <Link to="/Unicode-Task-3/login" className="uppercase text-blue-400">Login In</Link></p>
                    </div>
                </form >

                <div id="details" className="hidden flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    <ShowDetails fullname={fullName} mail={mail} phone={phone} gender={gender} bdate={bdate} age={age} />
                </div>
            </div>
        </>
    )
